...
Eigen::Matrix<double, 9, 17> MPCsolver::OCPsolDesigner(double deltaT, Eigen::Matrix<double, 3, 16> obstacle_force, Eigen::Vector3d ExternalForce, Eigen::Matrix<double, 15, 1> curState, Eigen::Matrix<double, 15, 16> ReferencePath, Eigen::Matrix<double, 15, 1> termState, Eigen::Matrix<double, 18, 2> CostFunction, Eigen::Matrix<double, 15, 2> stateLimits, Eigen::Matrix<double, 3, 2> input_constraint)
{

    // initialize 1st predictive state and control input
    Eigen::Matrix<double, 9, 17> StateInput = Eigen::Matrix<double, 9, 17>::Zero();
//    int num_iters_x, num_iters_y, num_iters_z;
    ...
    load_data(deltaT,obstacle_force, ExternalForce, curState, termState, ReferencePath, stateLimits, input_constraint, CostFunction);
...
void MPCsolver::load_data(double deltaT, Eigen::Matrix<double, 3, 16> obstacle_force, Eigen::Vector3d ExternalForce, Eigen::Matrix<double, 15, 1> InitialState, Eigen::Matrix<double, 15, 1> TerminalState, Eigen::Matrix<double, 15, 16> ReferencePath, Eigen::Matrix<double, 15, 2> StateConstraint, Eigen::Matrix<double, 3, 2> InputConstraint, Eigen::Matrix<double, 18, 2> CostFunction)
{
...
Eigen::Matrix<double, 9, 17> MPCsolver::use_solution(Vars vars)
{
   Eigen::Matrix<double, 9, 17> StateInput_output = Eigen::Matrix<double, 9, 17>::Zero();
   
//    for(int i=0; i<6; i++)
//    {
//        StateInput_output(i,0) = vars.x_0[i];
//    }
...
//                         vars.x_11[6], vars.u_0[0], vars.u_0[1];
