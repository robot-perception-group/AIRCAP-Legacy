/* Produced by CVXGEN, 2018-01-16 09:17:51 -0500.  */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 15))) {
      printf("A must be size (15,15), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
    ...
    if (this_var_errors == 0) {
      ...
      dest[1] = src[15];  /* (1,2) entry. */
      dest[2] = src[16];  /* (2,2) entry. */
      dest[3] = src[32];  /* (3,3) entry. */
      dest[4] = src[47];  /* (3,4) entry. */
      dest[5] = src[48];  /* (4,4) entry. */
      dest[6] = src[64];  /* (5,5) entry. */
      dest[7] = src[79];  /* (5,6) entry. */
      dest[8] = src[80];  /* (6,6) entry. */
      dest[9] = src[96];  /* (7,7) entry. */
      dest[10] = src[111];  /* (7,8) entry. */
      dest[11] = src[126];  /* (7,9) entry. */
      dest[12] = src[112];  /* (8,8) entry. */
      dest[13] = src[127];  /* (8,9) entry. */
      dest[14] = src[128];  /* (9,9) entry. */
      dest[15] = src[144];  /* (10,10) entry. */
      dest[16] = src[159];  /* (10,11) entry. */
      dest[17] = src[174];  /* (10,12) entry. */
      dest[18] = src[160];  /* (11,11) entry. */
      dest[19] = src[175];  /* (11,12) entry. */
      dest[20] = src[176];  /* (12,12) entry. */
      dest[21] = src[192];  /* (13,13) entry. */
      dest[22] = src[207];  /* (13,14) entry. */
      dest[23] = src[222];  /* (13,15) entry. */
      dest[24] = src[208];  /* (14,14) entry. */
      dest[25] = src[223];  /* (14,15) entry. */
      dest[26] = src[224];  /* (15,15) entry. */
      valid_vars++;
    }
  }
  this_var_errors = 0;
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 3))) {
      printf("B must be size (15,3), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
    ...
    if (this_var_errors == 0) {
      ...
      dest[2] = src[17];  /* (3,2) entry. */
      dest[3] = src[18];  /* (4,2) entry. */
      dest[4] = src[34];  /* (5,3) entry. */
      dest[5] = src[35];  /* (6,3) entry. */
      valid_vars++;
    }
  }
  this_var_errors = 0;
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 15))) {
      printf("L_stage must be size (15,15), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 15))) {
      printf("L_term must be size (15,15), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xN must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("x_0 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("x_max must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("x_min must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_0 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_1 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_2 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_3 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_4 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_5 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_6 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_7 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_8 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_9 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_10 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_11 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_12 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_13 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_14 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 15) && (mxGetN(xm) == 1))) {
      printf("xr_15 must be size (15,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  *mxGetPr(xm) = work.converged;
  ...
  xm_cell = mxCreateDoubleMatrix(15, 1, mxREAL);
