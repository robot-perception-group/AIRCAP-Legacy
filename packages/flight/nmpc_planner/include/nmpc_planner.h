...
class Planner
{
  ...
  public:
    Planner(NodeHandle *_nh, int selfID, int numRobots): nh(_nh), selfID_(selfID), numRobots_(numRobots)
    {
      ...
      nh->getParam("copterVelocityLimitX", copterVelocityLimitX);
      nh->getParam("copterVelocityLimitY", copterVelocityLimitY);
      nh->getParam("copterVelocityLimitZ", copterVelocityLimitZ);
